...
public class locationsend extends AsyncTask {
    ...
    public locationsend(Context context, String email, String subject, String message) {
...
//        Toast.makeText(context,message.toString(),Toast.LENGTH_LONG).show();
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try {
            ...
            mm.setSubject("Current Location/ Call log");
            mm.setText(message);
